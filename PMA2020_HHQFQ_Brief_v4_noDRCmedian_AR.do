...
* 	the Public_Analysis repository, please contact the PMA Data Management Team
...
*		- For example: local country "Niger_Niamey"
local country "insert country here"
...
local wealth "insert wealth here"
...
*	Median age at first marriage
	preserve
		pma2020mediansimple tem agemarriage 25 `weight'
		gen urban="All Women"
		tempfile afm_total
...
* 	Median age at first sex among all women who have had sex
	preserve
		...
		save tem, replace
		pma2020mediansimple tem age_at_first_sex 15 `weight'
		gen urban="All Women"
		tempfile afs_total
...
*	Median age at first contraceptive use among all women who have ever used contraception
	preserve
		...
		save tem, replace
		pma2020mediansimple tem age_at_first_use 15 `weight'
		gen urban="All Women"
		tempfile afc_total
...
*		of the PMA2020 survey, the variable ever_birth was used.
	...
	if _rc!=0 {
		...
		save tem, replace
		pma2020mediansimple tem agefirstbirth 25 `weight'
		gen urban="All Women"
		tempfile afb_total
...
tabout cp mcp longacting [aw=`weight'] ///
	using "PMA2020_`country'_`round'_HHQFQ_2Page_Analysis_`date'.xls", append ///
...
tabout cp mcp longacting if married==1 [aw=`weight'] ///
	using "PMA2020_`country'_`round'_HHQFQ_2Page_Analysis_`date'.xls", append ///
